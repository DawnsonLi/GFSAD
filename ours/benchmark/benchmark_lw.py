...
#numbers = ['8','10','19','27']
log = []
columns = ['value','mean_now', 'std_now', 'minus_mean_now_past', 'minus_mean_now_yes','minus_std_now_past', 'minus_std_now_yes', 'r_mean_now_past', 'r_mean_now_yes','lw1','lw2','lw3','1', '2', '3','4','5','6','7','8','lw4','lw5','lw6','ewma','pre_minus','pre_rate','yes_minus','yes_rate','label']
for num in numbers:
    print num
